...
with app.app_context():
    ...
    for link in links:
        ...
        postal_code = postal_code_label.find_next_sibling("div").find("input", class_="textbox")["value"] if postal_code_label else None
        ...
        psychologist.profile_picture = profile_photo_url
